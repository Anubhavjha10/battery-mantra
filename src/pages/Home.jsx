  ...
  const sliderData = [
    {
      ...
      subtitle: 'Best Quality Batteries For Your Vehicles & Homes',
      offer: 'Special Launch Discounts',
    },
    {
      bgImage: 'assets/images/slider/bg/1-2.jpg',
      title: 'Reliable Battery Backup',
      subtitle: 'Find The Perfect Power Gear For Every Need',
      offer: 'Premium Doorstep Service',
    },
  ];

  // Banners Data
  const banners = [
    { img: 'assets/images/banner/1-1-400x250.jpg', offer: 'Best Price', title: 'Automotive Batteries' },
    { img: 'assets/images/banner/1-2-400x250.jpg', offer: 'High Life', title: 'Inverter Batteries' },
    { img: 'assets/images/banner/1-3-400x250.jpg', offer: 'Reliable', title: 'UPS Batteries' },
  ];
  ...
  useEffect(() => {
    const fetchHomeData = async () => {
      ...
      try {
        ...
        setCategories(cats || []);
        // Split or map products to deals & new arrivals dynamically
            ...
            <div className="col-lg-12">
              {newProducts.length > 0 ? (
                ...
                <div className="py-5 text-center border rounded bg-white">
                  ...
                  <p className="lead mb-0 text-muted">Products will appear here.</p>
                </div>
              )}
            </div>
          </div>
