                ...
                {activeTab === 'information' && (
                  <div className="tab-pane fade show active">
                    <div className="product-information-body">
                      ...
                      <p className="short-desc mb-4">If you don't need the item with worry, you can contact us then we will help you to solve the problem, so please close the return request! Thanks</p>
                      <h4 className="title">Guarantee</h4>
                      <p className="short-desc mb-0">If it is the quality question, we will resend or refund to you; If you receive damaged or wrong items, please contact us and attach some pictures about product, we will exchange a new correct item to you after the confirmation.</p>
                    </div>
                  </div>
                )}
